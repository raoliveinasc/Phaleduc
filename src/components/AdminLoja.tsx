  ...
  const handleTestSmtp = async () => {
    ...
    try {
      ...
      if (!healthResponse.ok) {
        ...
        throw new Error(`Servidor indisponível (Status: ${healthResponse.status})`);
      }
      ...
      console.error('Detailed SMTP Test Error:', error);
      toast.error(`Erro: ${error.message || 'Erro de rede'}`);
    } finally {
